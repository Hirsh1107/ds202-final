...
```{r}
percent_flavor_model <- lm(review_overall ~ percents_flavor_data$'%Bitter' + percents_flavor_data$'%Sweet' + percents_flavor_data$'%Sour' + percents_flavor_data$'%Salty' + percents_flavor_data$'%Fruits' + percents_flavor_data$'%Hoppy' + percents_flavor_data$'%Spices' + percents_flavor_data$'%Malty', data = percents_flavor_data)

summary(percent_flavor_model)
```
